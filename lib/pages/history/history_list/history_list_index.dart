...
class HistoryListIndex extends StatefulWidget {
  HistoryListIndex({super.key});

  @override
  State<HistoryListIndex> createState() => _HistoryListIndexState();
}

class _HistoryListIndexState extends State<HistoryListIndex> {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultLogoLayout(
      ...
      titleName: division == 'sell' ? '전체 판매 내역' : '전체 구매 내역',
      child: Column(
