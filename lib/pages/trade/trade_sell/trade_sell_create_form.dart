...
class TradeSellCreateForm extends StatefulWidget {
  final TradeFormData formData;
  final Function(bool) onProcessableChanged;


  TradeSellCreateForm({required this.formData, required this.onProcessableChanged});

  @override
  State<TradeSellCreateForm> createState() => _TradeSellCreateFormState();
}
...
class _TradeSellCreateFormState extends State<TradeSellCreateForm> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      widget.onProcessableChanged(false);
    });
  }
          ...
          child: Column(
            ...
            children: [
              ...
              JoinTextFormField(
                  ...
                  maxLength: null,
                  onChanged: (String value) {
                    widget.formData.businessUserDescription = value;
                    _checkProcessable();
                  }),
              SizedBox(
                height: 20,
